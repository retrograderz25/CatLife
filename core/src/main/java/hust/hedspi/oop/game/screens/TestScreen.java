...
public class TestScreen implements Screen, IObserver {
    ...
    public void render(float delta) {
        ...
        if (Gdx.input.isKeyJustPressed(Input.Keys.H)) {
            ScreenManager.getInstance().pushScreen(new MinigameScreen(new TromMeoMinigame()));
            return;
        }
        if (Gdx.input.isKeyJustPressed(Input.Keys.F)) {
            ScreenManager.getInstance().pushScreen(new MinigameScreen(new CombatMinigame()));
            return;
        }
        if (Gdx.input.isKeyJustPressed(Input.Keys.J)) {
            ScreenManager.getInstance().pushScreen(new MinigameScreen(new CombatDonMinigame()));
            return;
        }
        if (Gdx.input.isKeyJustPressed(Input.Keys.N)) {
            ScreenManager.getInstance().pushScreen(new MinigameScreen(new NhayHipHopMinigame()));
            return;
        }
        if (Gdx.input.isKeyJustPressed(Input.Keys.G)) {
            ScreenManager.getInstance().pushScreen(new MinigameScreen(new ThoatKhoiLongMinigame()));
            return;
        }
        ...
        dialogFont.draw(batch, "Nhấn [M] Rhythm | [C] CaoMong | [E] ThoatCong | [B] BathGame | [T] TimTieuTam | [V] TronKimTiem | [H] TromMeo | [F] Combat | [J] CombatDon | [N] NhayHipHop | [G] ThoatLong | [WASD] Di chuyển", 50, 100);
