...
public class BathGameMinigame implements IMinigameStrategy {
    ...
    private static final int   BUBBLE_SIZE     = 24 * Constants.BATH_BUBBLE_SCALE; 
    ...
    private static final int ZONE_X = 148;  
    private static final int ZONE_Y = 175;   
    private static final int ZONE_W = 344;  
    private static final int ZONE_H = 300;  
    ...
    public void forceEnd(boolean win) {
        this.won = win;
        this.gameOver = true;
        hust.hedspi.oop.game.managers.StoryManager.getInstance().recordResult(MinigameID.PET_BATH, win);
    }
}